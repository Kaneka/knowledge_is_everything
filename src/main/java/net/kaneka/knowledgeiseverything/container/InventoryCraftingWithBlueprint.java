...
public class InventoryCraftingWithBlueprint implements IInventory{
    ...
    public InventoryCraftingWithBlueprint(Container eventHandlerIn, int width, int height)
    {
    ...
    {
        return "container.craftingwithblueprint";
    }
